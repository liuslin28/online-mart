          ...
          <ul class="cart-item-list">
            <li v-for="item in cartList" v-if="item.checked=='1'">
              ...
              <div class="cart-tab-2">
                <div class="item-price">{{item.salePrice|currency('元')}}</div>
              </div>
              ...
              <div class="cart-tab-4">
                <div class="item-price-total">{{(item.salePrice*item.productNum)|currency('元')}}</div>
              </div>
            </li>
          </ul>
        </div>
      ...
      <div class="price-count-wrap">
        <div class="price-count">
          <ul>
            <li>
              <span>商品总价:</span>
              <span>{{subTotal|currency('元')}}</span>
            </li>
            <li>
              <span>运费:</span>
              <span>{{shipping|currency('元')}}</span>
            </li>
            <li>
              <span>折扣:</span>
              <span>{{discount|currency('元')}}</span>
            </li>
            <li>
              <span>税费:</span>
              <span>{{tax|currency('元')}}</span>
            </li>
            <li class="order-total-price">
              <span>订单总价:</span>
              <span>{{orderTotal|currency('元')}}</span>
            </li>
          </ul>
        </div>
      </div>
